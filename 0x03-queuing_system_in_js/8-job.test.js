#!/usr/bin/node
/**
  * This script tests the `createPushNotificationsJobs` function using
  * the `kue`, `chai`, and `sinon` libraries. It validates the creation
  * of push notification jobs, and checks for job events like progress
